...
public class JWTUtils {
	...
	public final static String USER_ID_KEY = "Fuserid";
	...
	public static void main(String[] args) throws Exception {
		...
		claims.put("Fuserid", "402881466c9433e8016c9447c68e0003");
	//	claims.put("role", "user");
	//	claims.put(JWTUtils.USER_TYPE_KEY, UserTypeEnum.WX_USER.getCode());
		long expires = 8*60*60*1000;
		//unix时间戳，有效时间8小时
	//	System.out.println(createJWT(claims, "clinicalknowledgebase", expires));
